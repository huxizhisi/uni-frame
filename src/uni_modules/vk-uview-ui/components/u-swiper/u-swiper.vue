<template>
    ...
    >
        ...
        >
            <swiper-item class="u-swiper-item" v-for="(item, index) in list"  :key="item.fileUrl">
                <view
                ...
                >   
                    <view v-if="item.fileType == 'PRODUCT_VIDEO_TITLE_IMAGE' || item.fileType === 'PRODUCT_VIDEO'" 
                        style="position:relative;width:100%;height:480rpx">
                        <image class="u-swiper-image" :disabled="false" :controls='false' 
                            :autoplay='false' 
                            :src="item.fileType == 'PRODUCT_VIDEO_TITLE_IMAGE' ? item.fileUrl : item.fileUrl+'?x-oss-process=video/snapshot,t_0,f_jpg' " 
                            mode=""></image>
                        <view class="video-start">
                            <image src="/static/images/detail/bofang.svg" mode=""></image>
                        </view>
                    </view>

                    <image class="u-swiper-image" :src="item[name] || item" :mode="imgMode" v-else></image>
                    <view
