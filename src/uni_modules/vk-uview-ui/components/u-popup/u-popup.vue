<template>
    ...
    >
        ...
        >
            ...
            <view v-if="closeable && customer" @tap="close" class="u-close u-close-customer" >
            ...
            <view v-if="mode != 'center' && closeable && !customer" @tap="close" class="u-close" :class="['u-close--' + closeIconPos]">
                <u-icon
 ...
 * @property {Boolean} customer 是否用户自定义
