      ...
      for (let i = 0; i < trs.length; i++) {
        for (let j = 0, td; (td = trs[i].children[j]); j++) {
          if (td.name == "td" || td.name == "th") {
            ...
            let cell = {
              ...
              attrs: {
                style:
                  (td.attrs.style || "") +
                  (border
                    ? `;border:${border}px solid gray` + (spacing ? "" : ";border-right:0;border-bottom:0")
                    : "") +
            ...
            if (td.attrs.colspan) {
              cell.attrs.style +=
                ";grid-column-start:" + col + ";grid-column-end:" + (col + parseInt(td.attrs.colspan));
            ...
            if (td.attrs.rowspan) {
              ...
              for (let k = 1; k < td.attrs.rowspan; k++) map[row + k + "." + col] = 1;
            }
            children.push(cell);
            col++;
          }
