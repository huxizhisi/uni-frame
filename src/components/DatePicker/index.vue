 ...
 * @LastEditTime: 2024-09-13 16:51:22
 * @FilePath: \uni-frame\src\components\DatePicker\index.vue
 * @Description: 时间选择器
-->
  ...
  <view class="popup-mask" :class="{ visible: visibleRef }" @click="closePopup">
    <view class="popup-container">
      ...
      <view class="popup-content" :class="{ 'slide-in': visible }" @click.stop>
        ...
        <picker-view
          class="popup-datetime"
          :class="{ 'dark-black': isDark }"
          :value="dateTimeValue"
          @change="handleChange"
...
// 初始化从start到end的值范围
const initDateTime = (start = 0, end = 0) => {
  const arr = [];
