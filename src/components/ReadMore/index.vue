 ...
 * @LastEditTime: 2024-09-11 15:12:19
 * @FilePath: \uni-frame\src\components\ReadMore\index.vue
 * @Description: 查看更多
-->
...
<template>
  <view class="">
    ...
    >
      <view v-if="customerStyle">
        <slot name="cusomterText"></slot>
      </view>
      <view
 ...
 * @property {String} color 提示文字的颜色（默认#1790FF）
